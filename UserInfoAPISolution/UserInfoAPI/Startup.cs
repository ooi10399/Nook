...
namespace UserInfoAPI
{
    public class Startup
    {
        ...
        {
            // ==================================================================
            services.AddDbContext<UserInfoDbContext>(opts =>
            {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "UserInfoAPI", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "UserInfoAPI v1"));
            }
